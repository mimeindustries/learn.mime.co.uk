...
videosteps:
  ...
  - time: 67.7
    ...
    description: "Slot the centre grip support (part #16) and slot it on to the other end of the servo facing the same way as the other end"
  - time: 69.4
  ...
  - time: 108.6
    ...
    description: "Slot all of the tabs on the edges into place and attach an elastic on either side of the base"
  - time: 111.8
  ...
  - time: 120.0
    ...
    description: "Plug the two parts together using the ribbon cable included"
---
